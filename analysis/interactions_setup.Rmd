...
```{r plotInt10, fig.height=6, fig.width = 9, fig.cap = glue("*Distribution of significant interactions using {sz/1e3}kb bins*")}
gi %>%
  anchors("first") %>%
  seqnames() %>%
  table() %>%
...
```{r plotInt40, fig.height=6, fig.width = 9, fig.cap = glue("*Distribution of significant interactions using {sz/1e3}kb bins*")}
gi %>%
  anchors("first") %>%
  seqnames() %>%
  table() %>%
