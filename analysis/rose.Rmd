...
```{r plotRpmpbp, fig.width=8, fig.cap = "Comparison of H3K27AC signal within each candidate region. The curve of best fit is shown in blue, with y = x shown as the dashed, grey line."}
rpmpbp %>%
