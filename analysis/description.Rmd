...
Two technical replicates (`r pander(unique(samples$sample))`) were contained in this dataset and both were merged before detection of significant interactions.
