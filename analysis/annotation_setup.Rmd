...
- The manually generated `Seqinfo` was also placed as the foundation of this annotation object.
...
stateMap %>%
  ...
  pander(
    justify = "llllr",
    caption = "*Chromatin States as defined by the ChromHMM model*"
  )
```


```{r stateMapLegend, fig.width=3, fig.height=7, fig.cap="*Standard colours used to indicate ChromHMM predicted states*"}
stateMap %>%
