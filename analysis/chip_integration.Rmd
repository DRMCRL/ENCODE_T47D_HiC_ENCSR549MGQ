...
```{r plotWidths, fig.cap=glue("*Assessment of peak width for each set of consensus peaks. H3K27Ac peaks were noticeably wider than GATA3 or AR peaks, with AR peaks also appearing wider in the presence of DHT. The suggested peak size of {minWidth}bp is shown as a vertical line.*")}
allWidths %>%
...
BigWig files contain the more subtle information regarding coverage, whilst this classification can indicate copmlete loss or gain of binding.
